...
## Considerations 
we now register tools with the registry but our code still has direct registration and tools is context. This likely should habe been removed, the question is does future implementation not use it and it should have been omitted. 

Checking the final baseline example, we did correct the issue.
The contect should have referenced to tools[] its currently using, and the full table of tools registed should live on the registry.
